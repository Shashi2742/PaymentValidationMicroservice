...
public enum ValidatorEnum {
    ...
    VALIDATOR_RULE2("VALIDATOR_RULE2",DuplicateTxnCheck.class); 

    private static final Map<String, ValidatorEnum> NAME_TO_ENUM_MAP = new ConcurrentHashMap<>();
    private static Logger log = LoggerFactory.getLogger(ValidatorEnum.class);
    static {
    ...
    public static Class<? extends Validator> getClassByName(String name) {
        ...
        if (validatorEnum == null) {
            ...
            return null; // Handle the case where the validator is not found
        }
